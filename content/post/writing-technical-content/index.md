---
title: Подготовка к контрольнам работам
date: 2023-05-08
math: true
image:
  placement: 2
...
У нас была неделя контрольных по математикам и я решила поделиться с вами нашей подготокой к ним

## Examples

### Этап 1 Осознание

Один и самых тяжелых этапов, потому что принять то что у тебя будет две контрольные тяжело 
